...
function AnfrageFormProdukt(){
  const url_id = 'https://gop4n9bn.directus.app/items/anfrage_produkt'
  ...
  useEffect(() => {
    directus.items("anfrage_produkt").readByQuery({})
    .then(response => {
...
if(daten){
  return (
    ...
    <Row>
      <Col id="anfrage_produkt_body_text" >
          {
            setTimeout(()=>{document.getElementById("anfrage_produkt_body_text").innerHTML=daten.Text_Produktanfrage}, 0)
          }
      </Col>
    </Row>
      {/* Forms */}
